...
const uint8_t font_16x24_digits[10][16][3] = {
	{ // 0
	...
	{ // 1
	 {0x00,0x00,0x00},{0x02,0x00,0x00},{0x01,0x00,0x00},{0xFF,0xFF,0x03},
	...
	{ // 2
	 {0x03,0x00,0x02},{0x05,0x00,0x02},{0x09,0x00,0x02},{0x11,0x00,0x02},
	 {0x21,0x00,0x02},{0x41,0x00,0x02},{0x81,0x00,0x02},{0x01,0x01,0x02},
	 {0x01,0x02,0x02},{0x01,0x04,0x02},{0x01,0x08,0x02},{0x01,0x10,0x02},
	 {0x01,0x20,0x02},{0x01,0x40,0x02},{0xFF,0xFF,0x03},{0x00,0x00,0x00}
	},

	{ // 3
	 {0x03,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x7F,0x01,0x02},{0x7F,0x01,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x03,0x00,0x02},{0xFC,0xFF,0x01},{0x00,0x00,0x00}
	},

	{ // 4
	 {0x00,0x00,0x02},{0x00,0x00,0x02},{0x00,0x00,0x02},{0x00,0x00,0x02},
	 {0x00,0x00,0x02},{0x00,0x00,0x02},{0xFF,0xFF,0x03},{0xFF,0xFF,0x03},
	 {0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x01,0x00,0x02},{0x00,0x00,0x00},{0x00,0x00,0x00}
	},

	{ // 5
	 {0xFF,0xFF,0x03},{0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},
	 {0xFF,0xFF,0x01},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x03,0x00,0x02},{0xFC,0xFF,0x01},{0x00,0x00,0x00}
	},

	{ // 6
	 {0xFC,0xFF,0x01},{0x03,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0xFF,0xFF,0x01},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0x01,0x00,0x02},{0x03,0x00,0x02},{0xFC,0xFF,0x01},{0x00,0x00,0x00}
	},
	...
	{ // 7
	 ...
	 {0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},
	 {0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},
	 {0x01,0x00,0x00},{0x01,0x00,0x00},{0xFF,0xFF,0x03},{0x00,0x00,0x00}
	},
	...
	{ // 9
	 {0xFC,0xFF,0x01},{0x03,0x00,0x02},{0x01,0x00,0x02},{0x01,0x00,0x02},
	 {0xFC,0xFF,0x03},{0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},
	 {0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},{0x01,0x00,0x00},
	 {0x01,0x00,0x00},{0x03,0x00,0x00},{0xFC,0xFF,0x01},{0x00,0x00,0x00}
	}
